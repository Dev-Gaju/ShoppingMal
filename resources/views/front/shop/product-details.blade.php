                        ...
                        <div class="col-md-5">
                            <div class="product-entry">
                                ...
                                <div class="thumb-nail">
                                    <a href="#" class="thumb-img" style="background-image: url({{asset('/front')}}/images/item-11.jpg);"></a>
                                    <a href="#" class="thumb-img" style="background-image: url({{asset('/front')}}/images/item-12.jpg);"></a>
                                    <a href="#" class="thumb-img" style="background-image: url({{asset('/front')}}/images/item-16.jpg);"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-7">
